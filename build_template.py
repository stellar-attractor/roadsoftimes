...
/* ── Скрываем GameTown tab-блок (JS управляет sidebartab2/3) ─────── */
#rsidebar-wrapper .tabviewsection,
#rsidebar-wrapper .tabs-widget,
#sidebartab1{display:none!important}
/* sidebartab2/3 изначально скрыты, JS покажет нужный */
...
/* Toggle-стрелки */
#rsidebar-wrapper .BlogArchive a.toggle{display:inline-block!important;float:none!important;width:20px;font-size:10px;color:#8a6f2e;text-decoration:none;vertical-align:middle}
#rsidebar-wrapper .BlogArchive a.toggle .zippy{font-style:normal}
