...
/* Скрываем toggle-стрелки и счётчики */
#rsidebar-wrapper .BlogArchive a.toggle,
#rsidebar-wrapper .BlogArchive span.post-count{display:none!important}
/* Год (li.archivedate верхнего уровня) */
#rsidebar-wrapper .BlogArchive .hierarchy > ul > li.archivedate > a.post-count-link{
...
/* Месяц (li.archivedate вложенного .items) */
#rsidebar-wrapper .BlogArchive .hierarchy > ul > li > ul.items > li.archivedate > a.post-count-link{
...
#rsidebar-wrapper .BlogArchive .hierarchy > ul > li > ul.items > li.archivedate > a.post-count-link:hover{color:#c9a84c}
