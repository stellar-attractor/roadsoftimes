  ...
  if(card){
    ...
    if(thumb){
      if(previewTag==="video"){
        ...
        if(timg&&timg.src){timg.src=timg.src.replace(/\/s\d+(-c)?\//,'/s800/');}
      }
    }
  }
}"""
  ...
  <div class='rot-header-inner'>
    ...
    <nav class='rot-nav'>
      <ul>
        ...
        <li id='rot-nav-muzei'><a href='https://roadsoftimes.blogspot.com/p/museums.html'>&#1052;&#1091;&#1079;&#1077;&#1080;</a></li>
...
<b:else/>
  ...
  <article class='rot-post-card'>
    ...
    <div class='rot-card-body'>
      ...
      <div class='rot-card-excerpt'><data:post.snippet/></div>
      <div style='display:none' expr:id='&quot;summary&quot; + data:post.id'><data:post.body/></div>
...
"""
src = src.replace('</body>', SLIDER_JS + COMMENT_FIX_JS + VIEW_SWITCHER_JS + LABEL_BANNER_JS + NAV_ACTIVE_JS + TOGGLE_MENU_JS + WIDGET_PLACEMENT_JS + LATEST_POST_JS + '</body>')
